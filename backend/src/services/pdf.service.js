    ...
    try {
      ...
      const doc = new PDFDocument({
        ...
        info: {
          ...
          Creator: 'ScriptMD — Smart Digital Prescription Platform',
        },
      });
      ...
      doc.font('Helvetica').fontSize(7.5).fillColor(C.white)
         .text('✓  This is a digitally generated and verified prescription issued via ScriptMD Platform', sigX + 15, y + 121, { width: 315 });
      ...
      doc.font('Helvetica').fontSize(7.5).fillColor('#93c5fd')
         .text(
           `Generated by ScriptMD  ·  Prescription ID: ${rxId}  ·  ${rxDate}  ·  This document is system-generated and valid without a wet signature.`,
